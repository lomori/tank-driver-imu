...
public:
	...
	static double Linear(const double yValues[], int numValues, double pointX, bool trim = true);
	static double Linear(double minX, double maxX, const double yValues[], int numValues, double pointX, bool trim = true);
	static double Linear(const double xValues[], const double yValues[], int numValues, double pointX, bool trim = true);
